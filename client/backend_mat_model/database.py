...
class basa:
    ...
    def add_new_trunk(self,table_name, Model, ParamCharge, ParamQn,
                                     ParamQg,
                                     ParamQv,
                                     P,
                                     T,
        ...
        try:
            ...
            stmt = """INSERT
            INTO
            {}(Model, ParamCharge, ParamQn, ParamQg, ParamQv,
                   P,
                   T,
                   ParamFlowRegime,
                   ParamFacticVelocity,
            ...
            %s,
            %s,
            %s, UTC_TIMESTAMP())""".format(table_name)
    ...
    def get_trunk(self,table_name, Model):
        try:
            cursor = self._connection.cursor()
		...
		ParamCrash,
		ParamLifetime,
		ResidualResource, created FROM {}
    WHERE Model = {} """.format(table_name,Model)
